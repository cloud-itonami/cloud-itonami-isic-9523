# Operator Quickstart — Repair of footwear and leather goods

Shortest path from clone to a verified local dry-run for **ISIC 9523** (`cloud-itonami-isic-9523`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9523.git
cd cloud-itonami-isic-9523
```
...
- Likely source path: `leathergoods.governor.cljc`

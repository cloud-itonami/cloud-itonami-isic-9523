(ns leathergoods.operation
  ...
  when the governor is clean -- see `leathergoods.phase`."
  (:require [langgraph.graph :as g]
            [langgraph.checkpoint :as cp]
            [leathergoods.repairopsllm :as repairopsllm]
            [leathergoods.governor :as governor]
            [leathergoods.phase :as phase]
...
(defn build
  ...
  `leathergoods.store/Store`).
  opts:
    :advisor      -- a `leathergoods.repairopsllm/Advisor` (default: mock-advisor)

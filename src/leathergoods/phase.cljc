(ns leathergoods.phase
  "Phase 0->3 staged rollout -- the footwear-and-leather-goods-repair
  analog of `cloud-itonami-isic-9529`'s `specialtyrepair.phase`.
...
(def write-ops #{:ticket/intake :jurisdiction/assess :safety/screen
                 :brand/screen :repair/complete :item/return})
...
(def phases
  ...
  {0 {:label "read-only"       :writes #{}                                                                                :auto #{}}
   ...
   2 {:label "assisted-assess" :writes #{:ticket/intake :jurisdiction/assess :safety/screen :brand/screen}                :auto #{}}
